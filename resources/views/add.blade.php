...
<head>
	...
	<title>Sales record app >> Add new</title>
				...
				<div class="mt-2">
					<form action="/create" method="post" accept-charset="utf-8">
						...
						<div class="d-grid gap-3">
							<div>
								<input  type="text" class="form-control" name="product" placeholder="Product" value="{{ old('product') }}" required>
								@error('product')
							...
							<div>
								<div class="input-group">
									...
									<input type="number" class="form-control" name="amount" placeholder="Amount"  value="{{ old('amount') }}" required>
								</div>
								@error('amount')
									<div class="text-danger">{{ $message }}</div>
								@enderror
